            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="footer-widget">
                        <h2 class="widget-title">Parlour Address</h2>
                ...
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    <div class="footer-widget widget-newsletter">
                        ...
                        <p>Enter your email address to get the latest beauty tips and exclusive offers in your inbox.</p>
                        <form method="post">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="copyright-content">
                            <p>© Beauty Book Management System 2025 | Designed with ❤️</p>
                        </div>
                    </div>
                </div>
            </div>
